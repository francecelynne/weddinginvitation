  ...
  return (
    ...
    <div className='bg-[#545454] py-20 px-5'>
        ...
        <div className='flex justify-center items-center gap-5 mt-10'>
            <div>
                <div className='border lg:w-62.5 min-w-38 p-5 rounded-lg flex flex-col text-right gap-1 h-27.5 justify-center relative border-white'>
                    ...
                    <span className='min-w-18 min-h-18 bg-white rounded-full absolute -right-15 flex items-center justify-center'>
                        ...
                        <img src="https://media-public.canva.com/cFH4E/MAFcSycFH4E/1/t.png" alt=""  width="30" height="30"/>
                    </span>
                </div>
                <div className='border w-full p-5 rounded-lg flex flex-col text-right gap-1 h-27.5 justify-center mt-30.5 relative border-white'>
                    ...
                    <span className='min-w-18 min-h-18 bg-white rounded-full absolute -right-15 flex items-center justify-center'>
                        ...
                        <img src="https://media-public.canva.com/EW0II/MAEa23EW0II/1/t.png" alt=""  width="50" height="50"/>
                    </span>
                </div>
                <div className='border w-full p-5 rounded-lg flex flex-col text-right gap-1 h-27.5 justify-center mt-30.5 relative border-white'>
                    <span className='text-white/50 lg:text-md text-xs uppercase'>
                    ...
                    <span className='min-w-18 min-h-18 bg-white rounded-full absolute -right-15 flex items-center justify-center'>
                        ...
                        <img src="https://media-public.canva.com/YSN58/MAFSHrYSN58/1/t.png" alt=""  width="50" height="50"/>
                    </span>
                </div>
            </div>
            ...
            <div className=''>
                <div className='border lg:w-62.5 min-w-38 p-5 rounded-lg flex flex-col text-right gap-1 h-27.5 justify-center relative border-white'>
                    ...
                    <span className='min-w-18 min-h-18 bg-white rounded-full absolute -left-15 flex items-center justify-center'>
                        ...
                        <img src="https://media-public.canva.com/ifakA/MAG-yHifakA/1/t.png" alt=""  width="50" height="50"/>
                    </span>
                </div>
                <div className='border w-full p-5 rounded-lg flex flex-col text-right gap-1 h-27.5 justify-center mt-30.5 relative border-white'>
                    <span className='text-white/50 lg:text-md text-xs uppercase'>
                    ...
                    <span className='min-w-18 min-h-18 bg-white rounded-full absolute -left-15 flex items-center justify-center'>
                        ...
                        <img src="https://media-public.canva.com/ei4Yw/MAGWviei4Yw/1/t.png" alt=""  width="50" height="50"/>
                    </span>
                </div>
            </div>
        </div>
